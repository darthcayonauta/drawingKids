...
class MainActivity : AppCompatActivity() {
        ...
        permissions.entries.forEach {
            ...
            if( isGranted){
                Toast.makeText(this@MainActivity,
                    "Permiso concedido, ahora puedes leer el almacenamiento de archivos",
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val ibGallery : ImageView = findViewById(R.id.ib_gallery)
    ...
    fun paintClicked(view: View){
        ...
        if( view !== mImageButtonCurrentPaint ){
            ...
            //obtienes el valor del tag definido en activity_main.xml
            val colorTag = imageButton.tag.toString()

            //procedes a setear el color obtenido
            drawingView?.setColor(colorTag)

            //si presionas el btn, se ocuapara el pallet_pressed.xml
    ...
    private fun requestStoragePermission(){
        if(ActivityCompat.shouldShowRequestPermissionRationale(
            ...
            showRationaleDialog("Kids Drawing App",
                                     "Necesita acceder a tu Almacenamiento Externo",
            )
        }else{
